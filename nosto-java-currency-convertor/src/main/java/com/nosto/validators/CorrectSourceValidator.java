...
public class CorrectSourceValidator implements ConstraintValidator<CorrectSource, String> {
	
	private final String currencyRegex = "[A-Z]{3}";
	private final String[] currencies = {"USD", "GBP", "EUR", "JPY", "BGN", "CZK", "DKK", "HUF", "PLN", "RON",
